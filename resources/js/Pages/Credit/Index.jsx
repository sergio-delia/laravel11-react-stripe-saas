...
export default function Index({auth, packages, features, success, error}) {// auth viene passato tramite middleware di inertia js
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={
                <h2 className='font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight'>Your Credits</h2>
            }
        >
